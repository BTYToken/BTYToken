...
/**
   ...
   #LIQ+#RFI+#SHIB+#BytE, combine together to #Byt  

    I make this #Byt to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/BytTokenHECO
   ...
   I will renounce the ownership to burn addresses to transfer #Byt to the community, make sure it's 100% safe.

   I will add 1 HT and all the left 49% total supply to the pool
   Can you make #Byt 100X? 
   ...
   it's the best part of the #Byt idea, increasing the liquidity pool automatically, 
...
contract BytToken is Context, IERC20, Ownable {
    ...
    string private _name = "BYT Token";
    string private _symbol = "BYT";
